...
public class Game
{
    [Key] public int GameId { get; set; } // Primary key for the Game

    [Required] [StringLength(255)] public string GameName { get; set; } // Name of the Game

    public string GameAcronym { get; set; }
    public string GameImagePath { get; set; } // Path of the image for the game

    [Required] public string GameVersion { get; set; } // Version of the Game, changed to string for format flexibility

    [StringLength(1000)] public string? Description { get; set; } // Description of the Game
